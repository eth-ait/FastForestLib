...
namespace AIT {
	...
	std::vector<AIT::Image<data_type, label_type> > LoadImagesFromMatlabFile(const std::string &filename, const std::string &data_array_name = "data", const std::string &label_array_name = "label") {
		typedef AIT::Image<data_type, label_type> ImageType;
