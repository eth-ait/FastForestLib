...
inline double compute_elapsed_seconds(const std::chrono::high_resolution_clock::time_point& start_time) {
...
inline double compute_elapsed_milliseconds(const std::chrono::high_resolution_clock::time_point& start_time) {
